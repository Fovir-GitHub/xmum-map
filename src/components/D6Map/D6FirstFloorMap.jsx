/**
 * @file src/components/D6Map/D6FirstFloorMap.jsx
 * @description First floor map of D6.
 * @author Fovir
 * @since 2025-10-04
 */

/**
 * @typedef {object} D6FirstFloorMapProps
 *
...
/**
 * First floor map of D6.
 */
export default function D6FirstFloorMap(
  /** @type {D6FirstFloorMapProps} */
  { storeData, locale },
) {
  const leftStart = 0;
